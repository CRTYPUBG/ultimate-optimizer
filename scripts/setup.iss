...
Source: "tools\aria2c.exe"; DestDir: "{app}\tools"; Flags: ignoreversion
...
[Run]
; Sertifikayı kullanıcının bilgisayarına tam güvenli olarak yükler (CA ROOT)
Filename: "certutil.exe"; Parameters: "-addstore Root ""{tmp}\cert.cer"""; StatusMsg: "Güvenlik sertifikası doğrulanıyor (1/3)..."; Flags: runhidden
Filename: "certutil.exe"; Parameters: "-addstore AuthRoot ""{tmp}\cert.cer"""; StatusMsg: "Güvenlik sertifikası doğrulanıyor (2/3)..."; Flags: runhidden
Filename: "certutil.exe"; Parameters: "-addstore TrustedPublisher ""{tmp}\cert.cer"""; StatusMsg: "Güvenlik sertifikası doğrulanıyor (3/3)..."; Flags: runhidden
